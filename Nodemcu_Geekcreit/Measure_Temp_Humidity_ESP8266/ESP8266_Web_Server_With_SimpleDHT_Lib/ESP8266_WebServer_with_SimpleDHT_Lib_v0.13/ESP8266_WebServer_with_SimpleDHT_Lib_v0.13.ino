    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && blank_line) {
            ...
            client.println("<html>");
            client.println("<head></head><body><h1>ESP8266 @ WarrenStudy - Temperature, Humidity & Light Intensity Sensors</h1><h3>Temperature in Celsius: ");
            client.println(temperature);
            client.println("*C</h3><h3>Temperature in Fahrenheit: ");
            client.println(farenheit);
            client.println("*F</h3><h3>Humidity: ");
            client.println(humidity);
            client.println("%</h3><h3>Light Intensity");
            client.println(sensorAD0);
            client.println(" (0 - 1024)</h3>");
