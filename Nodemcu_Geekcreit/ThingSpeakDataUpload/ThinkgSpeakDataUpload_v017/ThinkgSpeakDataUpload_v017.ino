...
void loop ( void ) {
 ...
 //Blinking LED Third time
  ...
  String subject = "!!! Plant 3 Low On Water !!!";
  if(gsender->Subject(subject)->Send("timepass@timepass.com", "!!! Plant 3 (Dining Room, RHS Piano) Low On Water !!!")) {
    ...
    Gsender *gsender = Gsender::Instance();    // Getting pointer to class instance
  String subject = "!!! Plant 3 Low On Water !!!";
  if(gsender->Subject(subject)->Send("timepass1@timepass1.com", "!!! Plant 3 (Dining Room, RHS Piano) Low On Water !!!")) {
     Serial.println("Message send.");
  } else {
     Serial.print("Error sending message: ");
     Serial.println(gsender->getError());
