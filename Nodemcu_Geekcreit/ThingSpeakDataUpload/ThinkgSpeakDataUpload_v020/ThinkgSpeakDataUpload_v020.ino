...
void loop ( void ) {
 ...
 //Blinking LED Third time
  ...
  String subject = "!!! Plant 5 Low On Water !!!";
  if(gsender->Subject(subject)->Send("trevor@practicalperformanceanalyst.com", "!!! Plant 5 (Living Room, RHS Television) Low On Water !!!")) {
  ...
  {
  client.print("GET /apps/thingtweet/1/statuses/update?key=" + API + "&status=Current Soil Moisture Rdg for Plant 5 (Living Rm, LHS Telv) is " + tweet + " HTTP/1.1\r\n");
