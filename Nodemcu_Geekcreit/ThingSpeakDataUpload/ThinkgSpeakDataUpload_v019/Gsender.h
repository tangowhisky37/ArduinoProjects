...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "Your Base64 encoded login";
        const char* EMAILBASE64_PASSWORD = "Your Base64 encoded password";
        const char* FROM = "your_email_address@gmail.com";
