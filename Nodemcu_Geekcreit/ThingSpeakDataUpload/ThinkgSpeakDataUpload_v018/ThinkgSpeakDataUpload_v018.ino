...
void loop ( void ) {
 ...
 //Blinking LED Third time
  ...
  if(gsender->Subject(subject)->Send("trevor@practicalperf.com", "!!! Plant 4 (Living Room, LHS Television) Low On Water !!!")) {
    ...
    Gsender *gsender = Gsender::Instance();    // Getting pointer to class instance
  String subject = "!!! Plant 4 Low On Water !!!";
  if(gsender->Subject(subject)->Send("vf@gmail.com", "!!! Plant 4 (Living Room, LHS Television) Low On Water !!!")) {
     Serial.println("Message send.");
  } else {
     Serial.print("Error sending message: ");
     Serial.println(gsender->getError());
