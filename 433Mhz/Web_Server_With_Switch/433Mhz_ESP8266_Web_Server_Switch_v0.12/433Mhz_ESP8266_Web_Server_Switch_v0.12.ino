...
int d3 = 0;
  ...
  void docRoot(){
    ...
    webPage += "<br>";
    webPage += "<li>Turn On Switch #B <a href=\"socket2On\"><button>Switch ON</button></a>&nbsp;&nbsp;&nbsp;<a href=\"socket2Off\"><button>Switch OFF</button></a></li></ul>";
    webPage += "<br>";
    webPage += "<li>Turn On Switch #C <a href=\"socket3On\"><button>Switch ON</button></a>&nbsp;&nbsp;&nbsp;<a href=\"socket3Off\"><button>Switch OFF</button></a></li></ul>";
    webPage += "<br>";
    webPage += "<li>Turn On Switch #D <a href=\"socket4On\"><button>Switch ON</button></a>&nbsp;&nbsp;&nbsp;<a href=\"socket4Off\"><button>Switch OFF</button></a></li></ul>";
    webPage += "<br>";
